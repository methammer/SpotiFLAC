...
Since SpotiFLAC often runs in headless environments (like Docker), the authentication process requires a few manual steps using your browser and the SpotiFLAC API.
